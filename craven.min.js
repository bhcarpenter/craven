...
function y(a,b){var c=a.model;return q.call(b,function(a){a instanceof c||(a=new c(a));a.c("destroy",this.remove,this);return a},a)}function B(a,b){for(var c=b.length;c--;)b[c].b("destroy",a.remove,a)};var C={view:null,tagName:"div",id:"",className:""};function D(a,b){t(this,C,a);this.view||b||(this.view=t(document.createElement(u(this,"tagName")),u(this,"attributes"),{id:u(this,"id"),className:u(this,"className")}))}D.prototype.s=function(){};var E=D.prototype.remove=function(){var a=this.view,b=a.parentNode;b&&b.removeChild(a)};function F(a,b,c){D.call(this,b,c);a=this.model=a;a.c("change",G,this);a.c("destroy",H,this)}F.prototype=new D(null,!0);F.prototype.remove=function(){var a=this.model;a.b("change",G,this);a.b("destroy",H,this);E.call(this)};function G(){this.render()}function H(){this.remove()};function I(a,b,c){D.call(this,b,c);this.collection=a;this.k=[];this.g(a,0);a=this.collection;a.c("add",this.g,this);a.c("remove",this.l,this)}I.prototype=new D(null,!0);I.prototype.remove=function(){var a=this.collection;a.b("add",this.g,this);a.b("remove",this.l,this);E.call(this)};I.prototype.g=function(a,b){for(var c=document.createDocumentFragment(),d=a.length,f=Array(d),p;d--;)p=f[d]=new F(a[d]),c.appendChild(p.view);r(this.k,b,0,f);d=this.view;d.insertBefore(c,d.children[b])};
...
w.prototype.trigger=w.prototype.a;K.Collection=x;x.prototype.reset=x.prototype.n;x.prototype.remove=x.prototype.remove;x.prototype.removeAt=x.prototype.m;x.prototype.on=x.prototype.c;x.prototype.off=x.prototype.b;x.prototype.trigger=x.prototype.a;K.Controller=D;D.prototype.render=D.prototype.s;D.prototype.remove=D.prototype.remove;K.ModelController=F;K.CollectionController=I;K.Router=J;J.add=J.add;J.activate=J.q;J.navigate=J.navigate;}());
