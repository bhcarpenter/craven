...
function y(a,b){var c=a.model;return p.call(b,function(a){a instanceof c||(a=new c(a));a.c("destroy",this.remove,this);return a},a)}function B(a,b){for(var c=b.length;c--;)b[c].b("destroy",a.remove,a)};function C(a,b){t(this,a);this.view||b||(this.view=t(document.createElement(u(this,"tagName")),u(this,"attributes"),{id:u(this,"id"),className:u(this,"className")}))}C.prototype.view=null;C.prototype.tagName="div";C.prototype.id="";C.prototype.className="";C.prototype.attributes={};C.prototype.s=function(){};var D=C.prototype.remove=function(){var a=this.view,b=a.parentNode;b&&b.removeChild(a)};function E(a,b,c){C.call(this,b,c);if(this.model=a)a=this.model,a.c("change",F,this),a.c("destroy",G,this)}E.prototype=new C(null,!0);E.prototype.remove=function(){var a=this.model;a.b("change",F,this);a.b("destroy",G,this);D.call(this)};function F(){this.render()}function G(){this.remove()};function H(a,b,c){C.call(this,b,c);this.collection=a;this.k=[];this.g(a,0);a=this.collection;a.c("add",this.g,this);a.c("remove",this.l,this)}H.prototype=new C(null,!0);H.prototype.modelControllerType=E;H.prototype.remove=function(){var a=this.collection;a.b("add",this.g,this);a.b("remove",this.l,this);D.call(this)};
H.prototype.g=function(a,b){for(var c=document.createDocumentFragment(),d=a.length,f=Array(d),q;d--;)q=f[d]=new this.modelControllerType(a[d]),c.appendChild(q.view);r(this.k,b,0,f);d=this.view;d.insertBefore(c,d.children[b])};H.prototype.l=function(a,b){for(var c=a.length,d=this.k.splice(b,c);c--;)d[c].remove()};var I={j:[],add:function(a,b,c){var d={};d.pattern=RegExp(a.replace(/(^|\/):[\w\d]*(\/|$)/,"$1(.+)$2"));d.u=b;d.r=c;this.j.push(d)},q:function(){var a=this;window.addEventListener("popstate",function(){a.i(location.pathname)},!1)},navigate:function(a){window.history.pushState({},"",a);this.i(a)},i:function(a){for(var b=this.j,c=b.length,d,f;c--;)if(d=b[c],f=d.pattern.exec(a))f.unshift(),d.u.apply(d.r,f)}};var J={};window.Craven=J;J.Events=v;v.on=v.c;v.off=v.b;v.trigger=v.a;J.Model=w;w.subtype=function(a,b){function c(){d.apply(this,arguments);b&&b.apply(this,arguments)}var d=J.Model;c.prototype=new d;c.prototype.attributes=a;return c};w.prototype.reset=w.prototype.h;w.prototype.update=w.prototype.p;w.prototype.toJSON=w.prototype.toJSON;w.prototype.validate=w.prototype.v;w.prototype.save=w.prototype.o;w.prototype.destroy=w.prototype.t;w.prototype.on=w.prototype.c;w.prototype.off=w.prototype.b;
w.prototype.trigger=w.prototype.a;J.Collection=x;x.prototype.reset=x.prototype.n;x.prototype.remove=x.prototype.remove;x.prototype.removeAt=x.prototype.m;x.prototype.on=x.prototype.c;x.prototype.off=x.prototype.b;x.prototype.trigger=x.prototype.a;J.Controller=C;C.prototype.render=C.prototype.s;C.prototype.remove=C.prototype.remove;J.ModelController=E;E.subtype=function(a){function b(){E.apply(this,arguments);a&&a.apply(this,arguments)}b.prototype=new E(null,null,!0);return b};
